...
inline void herk(const char* uplo, const char* trans, int n, int k, float alpha, const float* a,
                 int lda, float beta, float* c, int ldc) {
  ssyrk_(uplo, trans, &n, &k, &alpha, a, &lda, &beta, c, &ldc);
}
inline void herk(const char* uplo, const char* trans, int n, int k, double alpha, const double* a,
                 int lda, double beta, double* c, int ldc) {
  dsyrk_(uplo, trans, &n, &k, &alpha, a, &lda, &beta, c, &ldc);
}
...
inline void her2k(const char* uplo, const char* trans, int n, int k, float alpha, const float* a,
                  int lda, const float* b, int ldb, float beta, float* c, int ldc) {
  ssyr2k_(uplo, trans, &n, &k, &alpha, a, &lda, b, &ldb, &beta, c, &ldc);
}
inline void her2k(const char* uplo, const char* trans, int n, int k, double alpha, const double* a,
                  int lda, const double* b, int ldb, double beta, double* c, int ldc) {
  dsyr2k_(uplo, trans, &n, &k, &alpha, a, &lda, b, &ldb, &beta, c, &ldc);
}
